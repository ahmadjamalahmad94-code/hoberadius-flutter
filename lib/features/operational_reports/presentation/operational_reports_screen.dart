...
const _reports = <String, _ReportDef>{
  ...
  'login-states': _ReportDef(
    'حالات الدخول الموحدة',
    'تجميع دخول اللوحة والبوابات ومصادقة الشبكة في سجل واحد.',
  ),
  ...
  'speed-failures': _ReportDef(
    'فشل تعديل السرعات',
    'أوامر السرعة والبروفايل التي فشلت وتحتاج مراجعة تشغيلية.',
  ),
  'used-cards': _ReportDef(
    'الكروت المستخدمة',
    'كل الكروت التي تم استخدامها مع MAC ووقت أول استخدام.',
  ),
  'balance-movements': _ReportDef(
    'حركات الرصيد',
    'حركات أرصدة المشتركين والمديرين والموزعين في سجل واحد.',
  ),
  'cash-transactions': _ReportDef(
    'الحركات النقدية',
    'دفعات الكاش والتحصيل اليدوي مع الخصومات والدقائق المكتسبة.',
  ),
};
...
String _label(String key) {
  const labels = {
    ...
    'result_status': 'نتيجة التنفيذ',
    'error_message': 'رسالة الخطأ',
    'used_by_mac': 'MAC المستخدم',
    'first_used_at': 'أول استخدام',
    'expire_at': 'ينتهي في',
    'revoked': 'ملغي',
    'plan_id': 'رقم الباقة',
    'plan_name': 'الباقة',

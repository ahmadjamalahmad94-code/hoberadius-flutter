...
class CardBatchImportResult {
  ...
  factory CardBatchImportResult.fromJson(Map<String, dynamic> json) {
    ...
    return CardBatchImportResult(
      ...
      insertedCount: _intValue(data['inserted_count']) ?? 0,
      skippedCount: _intValue(data['skipped_count']) ?? 0,
      radiusSyncEnabled: _boolValue(data['radius_sync_enabled']),
      radiusSyncedCount: _intValue(data['radius_synced_count']) ?? 0,
